...
write.xlsx(ph_sch_gar_prim, "Tables_PH.xlsx", sheetName = "schol_gar_prim",append=TRUE)
write.xlsx(ph_sch_gar_sec, "Tables_PH.xlsx", sheetName = "schol_gar_sec",append=TRUE)
