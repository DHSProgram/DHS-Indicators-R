...
# Date last modified:		February 4, 2022 by Shireen Assaf
# *******************************************************************************************************************************/
rm(list = ls(all = TRUE))
...
# To calculate the child's age at the start of the school year
# we have to specify the month and year of the start of the school year referred to in the survey
