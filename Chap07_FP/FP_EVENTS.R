...
IRevents <- IRdata %>%
  select(caseid, v001, v002, v003, v005, v007, v008, v011, v017, v018, v019, v021, v023, v101, v102, v106, v190, vcal_1, vcal_2, vcal_3, vcal_4, vcal_5, vcal_6, vcal_7, vcal_8, vcal_9)
  

# set up which calendar columns to look at - column numbers can vary across phases of DHS
col1 <- 1 #  method use and pregnancies - always column 1
col2 <- 2 #  reasons for discontinuation - usually column 2
col3 <- 3 #  marriage - when it exists it is usually column 3
...
# ------------------------------------------------------------------------
# NOTE:  Convert calendar into separate variables per month.
# Starting at the chronological beginning of the calendar, episodes are counted when there is a change from one month to another.
# ------------------------------------------------------------------------
